...
## Architektura Danych
Baza danych części tworzona przez bota będzie centralnym punktem odniesienia, łączącym fizyczne przedmioty z ich cyfrowym śladem (schematy, stopklatki z napraw, parametry techniczne).
